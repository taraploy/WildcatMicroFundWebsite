...
/*This file is used for the SendGrid e-mail 
 to send a message to the user when registering.*/
    ...
    public class EmailSender 
    {
        ...
        public Task Execute(string apiKey, string subject, string message, string email)
        {
            ...
            var msg = new SendGridMessage()
            {
                ...
                From = new EmailAddress("WildcatMicrofund@weber.edu", Options.SendGridUser),
                Subject = subject,
